...
class UserProfile(Base):
    ...
    owner_chats: Mapped[List['ChatGroup']] = relationship(back_populates='owner',
...
class ChatGroup(Base):
    ...
    owner: Mapped[UserProfile] = relationship(UserProfile, back_populates='owner_chats')
